        ...
        $rootNode
          ->children()
            ...
            ->booleanNode('legacy_mode')
              ->defaultFalse()
              ->info('Enable to integrate with Opencast 1.x (Using episode service instead of archive service)')
            ->end()
            ...
            ->scalarNode('scheduler')
              ->defaultValue('/admin-ng/index.html#/events/events')
              ->info('Opencast schedule URL or path (default for OC 2.x /admin-ng/index.html#/events/events). For OC 1.x use /admin/index.html#/recordings. For OC 2.x /admin-ng/index.html#/recordings is also valid.')
            ->end()
