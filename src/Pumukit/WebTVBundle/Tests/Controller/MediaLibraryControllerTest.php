...
class MediaLibraryControllerTest extends WebTestCase
{
    private $dm;
    private $router;
    private $factory;
...
*/
	...
	$client = static::createClient();
        $crawler = $client->request('GET', '/mediateca');
    ...
    public function testMediaLibraryAlphabetically()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/mediateca/alphabetically');
